...
import java.applet.*;
/*
<applet code = "Form" width = 1000 height = 1000></applet>
*/
public class Form extends Applet
{
	...
	{
    	f=new Frame1("Student Response Form - Title");
  }
}
...
class Frame1 extends Frame implements ActionListener, FocusListener
{
	...
	public Frame1(String s)
	{
		...
		t1=new TextField("");add(t1);t1.setBounds(200+20,100+55,120,20);t1.addFocusListener(this);t1.setFont(myFont);t1.setForeground(Color.gray);t1.setText("9 Digits Required");
		...
		cb1=new Checkbox("Male",cbg,true);add(cb1);cb1.setBounds(200+20,200+55,65,20);cb1.setFont(myFont);
		cb2=new Checkbox("Female",cbg,false);add(cb2);cb2.setBounds(260+20,200+55,95,20);cb2.setFont(myFont);
		...
		c1=new Choice();add(c1);c1.setBounds(200+20,250+55,100,20);c1.setFont(myFont);c1.add("B-Tech");c1.add("M-Tech");
		...
		c3=new Choice();add(c3);c3.setBounds(200+20,350+55,70,20);c3.setFont(myFont);c3.add("1");c3.add("2");c3.add("3");c3.add("4");

		c4=new Choice();add(c4);c4.setBounds(200+20,400+55,70,20);c4.setFont(myFont);
		for(int i=1;i<=31;i++)
		{
			c4.add(Integer.toString(i));
		}
		c5=new Choice();add(c5);c5.setBounds(270+20,400+55,70,20);c5.setFont(myFont);
		for(int i=1;i<=12;i++)
		{
			c5.add(Integer.toString(i));
		}
		c6=new Choice();add(c6);c6.setBounds(340+20,400+55,70,20);c6.setFont(myFont);
